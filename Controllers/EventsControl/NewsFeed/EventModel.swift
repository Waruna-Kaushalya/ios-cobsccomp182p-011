...
class EventModel {
    ...
    init(image:String, title:String,eventDescription:String,userFirstName:String,userLastName:String,userProfileImage:String,goingCount:Int,eventIdentifire:String,goingUsers:[String],userID:String,currntUserID:String,contactNumber:String,userFBUrl:String,eventAddedDate:String,userCurrentLocation:String) {
